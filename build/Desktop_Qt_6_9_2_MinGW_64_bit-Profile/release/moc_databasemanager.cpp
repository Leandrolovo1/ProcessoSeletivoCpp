...
void databaseManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (databaseManager::*)(const QString & )>(_a, &databaseManager::connectionError, 0))
            return;
    }
}
...
// SIGNAL 0
void databaseManager::connectionError(const QString & _t1)
{
